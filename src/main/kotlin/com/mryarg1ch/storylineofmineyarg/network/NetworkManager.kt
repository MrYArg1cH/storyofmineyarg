...
object NetworkManager {
    ...
    fun registerPackets() {
        ...
        INSTANCE.messageBuilder(SaveSettingsPacket::class.java, messageId++)
            .decoder(::SaveSettingsPacket)
            .encoder(SaveSettingsPacket::encode)
            .consumerMainThread(SaveSettingsPacket::handle)
            .add()
    }
