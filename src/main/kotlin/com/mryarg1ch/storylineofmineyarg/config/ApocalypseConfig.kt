...
class ApocalypseConfig {
    ...
    var mobSpawnCoefficient: Int = 30
        set(value) { field = value.coerceIn(1, 100) }
    ...
    fun loadConfig(configDir: File) {
        ...
        try {
            ...
            println("[${StorylineOfMineyarg.MOD_NAME}] INFO: Configuration loaded successfully")
            
        } catch (e: Exception) {
            System.err.println("[${StorylineOfMineyarg.MOD_NAME}] ERROR: Failed to load configuration: ${e.message}")
    ...
    fun saveConfig(configDir: File) {
        ...
        try {
            ...
            println("[${StorylineOfMineyarg.MOD_NAME}] INFO: Configuration saved successfully")
            
        } catch (e: Exception) {
            System.err.println("[${StorylineOfMineyarg.MOD_NAME}] ERROR: Failed to save configuration: ${e.message}")
        }
    }
    ...
    fun resetToDefaults() {
        ...
        mobSpawnCoefficient = 30
        mobEvolutionSpeedCoefficient = 75
        snowfallSpeedCoefficient = 25
        enableProgressLogging = true
        snowSpawnPosition = null
        
        println("[${StorylineOfMineyarg.MOD_NAME}] INFO: Configuration reset to defaults")
    }
