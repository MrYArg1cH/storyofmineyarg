...
object PauseCommand {
    ...
    private fun execute(context: CommandContext<CommandSourceStack>): Int {
        ...
        try {
            ...
            StorylineOfMineyarg.LOGGER.error("Ошибка при приостановке апокалипсиса: ${e.message}")
    ...
    private fun executeResume(context: CommandContext<CommandSourceStack>): Int {
        ...
        try {
            ...
            StorylineOfMineyarg.LOGGER.error("Ошибка при возобновлении апокалипсиса: ${e.message}")
