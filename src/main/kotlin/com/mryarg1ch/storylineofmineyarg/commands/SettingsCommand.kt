...
object SettingsCommand {
    ...
    private fun execute(context: CommandContext<CommandSourceStack>): Int {
        ...
        try {
            ...
            val settingsContainer = ApocalypseSettingsScreen.createContainer(player)
            NetworkHooks.openScreen(player, settingsContainer)
            ...
            StorylineOfMineyarg.LOGGER.error("Ошибка при открытии настроек: ${e.message}")
