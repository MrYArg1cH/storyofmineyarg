...
object TestCommand {
    ...
    private fun execute(context: CommandContext<CommandSourceStack>): Int {
        ...
        try {
            ...
            player.sendSystemMessage(Component.literal("§e- Увеличение спавна зомби: через 30 секунд"))
            player.sendSystemMessage(Component.literal("§e- Снегопад: через 60 секунд"))
            player.sendSystemMessage(Component.literal("§e- Эволюция зомби: через 90 секунд"))
            ...
            System.err.println("[${StorylineOfMineyarg.MOD_NAME}] ERROR: Ошибка при запуске тестового режима: ${e.message}")
